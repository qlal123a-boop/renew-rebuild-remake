...
-- ===== Grants =====
GRANT SELECT ON public.lessons, public.worksheets, public.channels, public.summaries, public.courses, public.site_settings TO anon, authenticated;
GRANT INSERT, UPDATE, DELETE ON public.lessons, public.worksheets, public.channels, public.summaries, public.courses, public.site_settings TO authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.moderator_requests, public.site_admins TO authenticated;
GRANT SELECT, INSERT ON public.quiz_attempts TO anon, authenticated;
GRANT USAGE, SELECT ON SEQUENCE public.moderator_requests_id_seq, public.site_admins_id_seq TO authenticated;
GRANT ALL ON public.lessons, public.worksheets, public.channels, public.summaries, public.courses, public.site_settings, public.moderator_requests, public.site_admins, public.quiz_attempts TO service_role;
